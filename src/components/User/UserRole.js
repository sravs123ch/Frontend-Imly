...
function UserRoleForm() {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (editingIndex !== null) {
      ...
      updatedRoles[editingIndex] = {
        ...formData,
        id: updatedRoles[editingIndex].id,
      };
      ...
      setRoleData([
        ...roleData,
        { ...formData, id: (roleData.length + 1).toString() },
      ]);
    }
    handleCancel();
  };
  ...
  const emptyRows =
    rowsPerPage - Math.min(rowsPerPage, roleData.length - page * rowsPerPage);
                      ...
                      <StyledTableRow key={row.id}>
                        ...
                        <StyledTableCell>
                          <button
                            type="button"
                            onClick={() =>
                              handleEditClick(page * rowsPerPage + index)
                            }
